<?php
    /*
    Plugin Name: CTL Arcade - Brick Out
    Plugin URI: http://www.codethislab.com/
    Description: Brick Out for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeBrickOut{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-brick-out";
        private $_szPluginName              = "Brick Out";
        private $_szAspectRatio             = "9:11";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "arkanoid, breakout, classic game, arcade game, retro game, touch game, wordpress game, admob, share score, leaderboard, bricks, blocks, powerups, pinball, retro game";
    ...
    $g_oCTLArcadeBrickOut =  new CTLArcadeBrickOut();
