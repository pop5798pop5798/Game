 ...
 */
 ...
 //選取提示文字
var selectTextDisplay = '請選取 [NUMBER] 個數字'; //select number text display
...
var score_arr = [50,100,500,1000,10000];
...
function buildGameButton(){
	...
	/*$(window).resize(function(){
		bettxt.x = stageWidth/2 ;
		bettxt.y = stageHeight/100 * 95;
	});*/
	
	//$('#canvasHolder').prepend('<input id="box" type="text">');
...
function startSpin(){
	...
	if(gameData.selectArray.length == score_arr.length){
		...
		//樂透號碼
		gameData.revealArray = [0,1,2,3,4];
