...
var guide = false;
var canvasContainer, mainContainer, gameContainer, confirmContainer, resultContainer,betContainer,betMoneyContainer;
...
function buildGameCanvas(){
	...
	betConfirmMessageTxt.y = canvasH/100 *47;
	...
	/*bettxt = new createjs.DOMElement("box");
	//stage.addChild(txt);
	//centerReg(bettxt);
	bettxt.x = stageWidth/2 +180;
	bettxt.y = stageHeight/100*87;
	bettxt.htmlElement.value = "請輸入投注額(最低10,000)";
	bettxt.regX = 150;
	bettxt.regY = 150;
	...
	/*var input = new CanvasInput(
	{
	 ...
	 textField.x = canvasW/100* 39;
	 textField.y = canvasH/100 * 50;
	 textField.width = 250;
	 //textField.color = '#fff';
	...
	textField.x = 100;
	textField*/
	textField.placeHolder = "請輸入投注額(最低10,000)"; // updates the default text
	...
	//下注確認按鈕
	buttonconfirmBet = new createjs.Bitmap(loader.getResult('confirmBet'));
	centerReg(buttonconfirmBet);
	/*buttonconfirmBet.x = bettxt.x-50;
	buttonconfirmBet.y = canvasH/100 * 79;
	buttonconfirmBet.scaleX = 0.5;
	buttonconfirmBet.scaleY = 0.5;*/
	...
	betMoneyContainer.addChild(itemBetConfirm,buttonBetConfirm,buttonBetCancel,betConfirmMessageTxt,textField);
	...
	canvasContainer.addChild(bg, mainContainer, gameContainer, resultContainer, confirmContainer,betContainer, buttonFullscreen, buttonSoundOn, buttonSoundOff, buttonExit, guideline,betMoneyContainer);
